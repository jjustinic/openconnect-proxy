...
cat "${OPENCONNECT_PASSWORD_FILE}" | openconnect --script-tun --script "ocproxy -D 11080" --authgroup "${OPENCONNECT_GROUP}" -u "${OPENCONNECT_USER}" --passwd-on-stdin "${OPENCONNECT_HOST}"
